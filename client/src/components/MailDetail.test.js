...
describe('verify MailDetail Snapshot', () => {
  it('loads maildetail', () => {
    const mailDetail = render(<MailDetail messageDetail={mockMessageDetail} />)
    expect(mailDetail).toMatchSnapshot()
  })
})
